...
export default {
  ...
  mobileImport: {
    ...
    confirmLeaveWhileIndexing: "デバイスの索引作成はまだ実行中です。このページを離れてもバックエンドの取り込みは停止しませんが、ここでのリアルタイム出力は更新されなくなります。このまま離れますか？",
    ...
    indexLimit: "索引化する写真数",
    indexed: (count) => `デバイスの写真ライブラリ索引が完了しました：${count} 件`,
    indexedImported: (count) => `デバイスの写真ライブラリ索引が完了しました：${count} 件を取り込みました`,
    indexedSkipped: (count) => `デバイスの写真ライブラリ索引が完了しました：strict 重複のため ${count} 件をスキップしました`,
    importedItem: (target, path) => `取り込み：${target} -> ${path}`,
    indexing: "デバイスの写真ライブラリ索引を作成中...",
    indexFailed: "デバイスの写真ライブラリ索引作成に失敗しました",
    lastIndexedAt: "最終索引",
    leavePage: "このまま離れる",
    liveOutput: "デバイス出力",
    logEmpty: "スマホ取り込み操作はまだ開始されていません。",
    mediaCount: "メディア",
    noMorePhotos: "処理できる写真はもうありません。",
    noDevice: "デバイス未読み込み",
    noDeviceDetected: "利用可能なデバイスが見つかりません",
    pageIntro: "スマホ内の写真を索引化・取り込みし、元ファイルの削除は明示的な操作に限定します。",
    pageTitle: "スマホ取り込み",
    pending: "接続待ち",
    ready: "準備完了",
    ...
    storageNote: "デバイス Hash はデバイスIDごとにローカルへ保存します。明示的に選択しない限り、元の写真はスマホ上に残します。"
  },
  similarity: {
    backToGallery: "メイン画面へ戻る",
    clear: "クリア",
