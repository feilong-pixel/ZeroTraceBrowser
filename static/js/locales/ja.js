...
export default {
  ...
  duplicates: {
    ...
    confirmBulkCurrentPageDelete: (count, method) =>
            `このページの ${method} 重複ファイル ${count} 件をごみ箱へ移動します。残す側のファイルは削除しません。続行しますか？`,
    confirmBulkStrict100Delete: (count) =>
            `このページから最大 100 グループ分、完全一致の重複ファイル ${count} 件をごみ箱へ移動します。残す側のファイルは削除しません。続行しますか？`,
    confirmBulkStrictDelete: (count) =>
            `このページの完全一致ファイル ${count} 件をごみ箱へ移動します。残す側のファイルは削除しません。続行しますか？`,
    ...
    methodStrict: "完全一致",
    nextPage: "次のページ",
    noMethodResults: "選択した検出方式の重複結果はありません。",
    noResults: "重複結果はまだありません。",
