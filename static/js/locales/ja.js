...
export default {
  ...
  duplicates: {
    ...
    bulkDeleting: (count) => `${count} 件を処理中...`,
    bulkDisabledForPhash: "類似画像は手動確認が必要なため一括削除できません",
    bulkMoveToRecycle: "一括削除",
    bulkStrictTitle: (count) => `${count}件の重複ファイルを削除`,
    confirmBulkStrictDelete: (count) =>
          `${count} 件の重複ファイルをごみ箱へ移動します。続行しますか？`,
    deleteSelected: "削除",
    deleted: (path) => `${path} をごみ箱へ移動しました`,
    ...
    noStrictDuplicatesToDelete: "削除対象がありません",
    openTasksTool: "整理ツール",
  ...
  recycle: {
    ...
    backToGallery: "メイン画面へ戻る",
    clearRecycle: "空にする",
    cleared: (count) => `${count}件を完全削除しました`,
    ...
    confirmClear: {
      confirm: "ごみ箱を空にする",
      message: "ごみ箱を空にしますか？この操作は元に戻せません。",
      messagePermanent: "ごみ箱を空にしますか？この環境ではファイルは完全に削除され、復元できません。",
      messageSystemRecycle: "ごみ箱を空にしますか？ファイルは Windows のシステムごみ箱へ移動されます。",
      title: "ごみ箱を空にする"
    },
    confirmClearLogs: {
      confirm: "ログを消去",
