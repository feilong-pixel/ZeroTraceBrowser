...
export default {
  ...
  iphone: {
    ...
    buildIndex: "このデバイスの写真ライブラリ索引を作成",
    cancelIndex: "索引作成をキャンセル",
    cancelIndexPending: "索引作成のキャンセルAPIは未接続です。実行中のバックエンド索引処理は継続します。",
    clearSelection: "クリア",
    clearSelectionPending: "結果の選択解除APIは未接続です。",
    copyAllPhotos: "デバイス内のすべての写真をコピー",
    detectDevice: "デバイス検出",
    detectFailed: "デバイス検出に失敗しました",
    detecting: "デバイスを検出中...",
    detectPending: "デバイス検出APIは未接続です。この画面は検出結果を受け取れる状態です。",
    deviceDetected: "デバイスを検出しました",
    deletePending: "削除APIは未接続です。次の段階でごみ箱記録へ書き込みますが、iPhone 上の元ファイルはローカルから復元できません。",
    deleteSelected: "削除",
    deleteFromDevice: "iPhone から削除",
    deleteFromDeviceFailed: "iPhone からの削除に失敗しました",
    deletedFromDevice: (target) => `iPhone から削除しました：${target}`,
    deleteTarget: "iPhone から削除する写真",
    deleteTargetMissing: "iPhone から削除する写真ファイル名を入力してください。",
    deleteTargetPlaceholder: "例 100APPLE/IMG_0001.JPG",
    deletingFromDevice: "iPhone から写真を削除しています...",
    deletingTarget: (target) => `iPhone から削除します：${target}`,
    deviceName: "デバイス",
    deviceSection: "デバイス",
    deviceSelect: "接続中の iPhone",
    deviceSummary: "デバイス概要",
    endDate: "終了日",
    indexLimit: "索引化する写真数",
    indexed: (count) => `このデバイスの写真ライブラリ索引が完了しました：${count} 件`,
    indexedImported: (count) => `このデバイスの写真ライブラリ索引が完了しました：${count} 件を取り込みました`,
    indexedSkipped: (count) => `このデバイスの写真ライブラリ索引が完了しました：strict 重複のため ${count} 件をスキップしました`,
    indexing: "このデバイスの写真ライブラリ索引を作成中...",
    indexFailed: "このデバイスの写真ライブラリ索引作成に失敗しました",
    indexPending: "このデバイスの写真ライブラリ索引を作成します。",
    invertSelection: "選択反転",
    invertSelectionPending: "結果の選択反転APIは未接続です。",
    lastIndexedAt: "最終索引",
    liveOutput: "デバイス出力",
    logEmpty: "iPhone 操作はまだ開始されていません。",
    mediaCount: "メディア",
    filenameMissing: "iPhone 写真ライブラリ内の画像ファイル名を入力してください。",
    method: "方式",
    methodEmbedding: "文書ベクトル",
    methodPhash: "pHash",
    movePending: "ローカルギャラリーへ移動するAPIは未接続です。",
    moveToLocalGallery: "ローカルギャラリーへ移動",
    noDevice: "デバイス未読み込み",
    noDeviceDetected: "iPhone デバイスが見つかりません",
    noResults: "類似結果はまだありません。",
    pageIntro: "接続中の iPhone の写真を索引化し、ローカルギャラリーへ取り込まずに類似写真を確認します。",
    pageTitle: "iPhone 類似検索",
    pending: "接続待ち",
    queryFilename: "iPhone ライブラリ内で類似写真を探したい画像のファイル名を入力してください：",
    queryFilenamePlaceholder: "例 IMG_2706.JPG",
    ready: "準備完了",
    reviewSection: "類似検索",
    scanScope: "スキャン範囲",
    scopeDcim: "DCIM",
    scopeRecent: "最近のサンプル",
    searchPending: "類似検索APIは未接続です。現在の検索条件は画面に保持されます。",
    searchSimilar: "類似写真を検索",
    selectAll: "全選択",
    selectAllPending: "結果の全選択APIは未接続です。",
    storage: "保存",
    storageNote: "デバイス Hash はデバイスIDごとにローカル SQLite へ保存し、元の写真は iPhone 上に残します。",
    startDate: "開始日",
    threshold: "しきい値"
  },
  similarity: {
    ...
    methodEmbedding: "文書ベクトル",
    methodPhash: "pHash",
    noMatches: "類似画像は見つかりませんでした。Hash DB を再構築するか、必要に応じてしきい値を上げてください。",
    noResults: "類似結果はまだありません。",
    pageIntro: "現在のローカル画像フォルダから、指定した1枚の画像に似た写真を検索します。",
    pageTitle: "類似写真検索",
    queryImage: "検索画像",
    queryMissing: "現在の画像フォルダ内の相対パスを入力してください。",
    queryPath: "検索画像の相対パス",
    queryPathPlaceholder: "例 2026/05/IMG_0001.JPG",
    querySummary: "検索概要",
    ...
    selectAll: "全選択",
    scope: "範囲",
    scopeNote: "最初の版では現在のローカル画像フォルダのみ検索します。今後 iPhone / Android の索引をこのページに接続できます。",
