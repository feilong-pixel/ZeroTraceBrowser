...
export default {
  ...
  maintenance: {
    backToTasks: "任务",
    galleryIndexHelp: "重建当前 root 的图库图片索引、总数和 Timeline 导航。不重建 Hash DB，也不重建重复结果。",
    galleryIndexRoot: "当前图库 root",
    galleryIndexTitle: "图库索引",
    hashMaintenanceHelp: "重建当前 root 的文件 Hash 和重复检测结果。通常会比图库索引重建耗时更久。",
    hashMaintenanceTitle: "Hash DB 与重复结果",
    pageIntro: "重建索引，并维护长期运行后的图库元数据。",
    pageTitle: "维护"
  },
  tasks: {
    backToGallery: "返回主画面",
    confirmLeaveWhileRunning: "当前处理仍在执行。现在返回主画面可能中断当前处理或停止本页监控，是否继续？",
    confirmRunImageIndexRebuild: "确认重建该目录的图库索引和 Timeline 吗？",
    ...
    maintenanceMovedHelp: "索引重建、时间戳修复和长期维护已移到维护页面。",
    ...
    pageTitle: "Media Engine 任务",
    phashThreshold: "pHash 阈值",
    runImageIndexRebuildTask: "重建图库索引",
    runRebuildTask: "重建结果",
    runTask: "开始整理",
