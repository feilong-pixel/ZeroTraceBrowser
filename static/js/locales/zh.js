...
export default {
  ...
  iphone: {
    ...
    cancelIndex: "取消索引",
    cancelIndexPending: "取消索引功能尚未接入。当前后台索引不会被中断。",
    clearSelection: "清除",
    clearSelectionPending: "结果选择清除功能尚未接入。",
    copyAllPhotos: "拷贝设备全部的照片",
    detectDevice: "检测设备",
    detectFailed: "设备检测失败",
    detecting: "正在检测设备...",
    ...
    deleteSelected: "删除",
    deleteFromDevice: "从 iPhone 删除照片",
    deleteFromDeviceFailed: "从 iPhone 删除照片失败",
    deletedFromDevice: (target) => `已从 iPhone 删除：${target}`,
    deleteTarget: "要从 iPhone 删除的照片",
    deleteTargetMissing: "请输入要从 iPhone 删除的照片文件名。",
    deleteTargetPlaceholder: "例如 100APPLE/IMG_0001.JPG",
    deletingFromDevice: "正在从 iPhone 删除照片...",
    deletingTarget: (target) => `准备从 iPhone 删除：${target}`,
    deviceName: "设备",
    deviceSection: "设备",
    ...
    endDate: "结束日期",
    indexLimit: "索引照片数量",
    indexed: (count) => `该设备图片库索引完成：${count} 张图片`,
    indexedImported: (count) => `该设备图片库索引完成：已导入 ${count} 张图片`,
    indexedSkipped: (count) => `该设备图片库索引完成：${count} 张图片已因 strict 重复跳过`,
    indexing: "正在建立该设备图片库索引...",
    indexFailed: "建立该设备图片库索引失败",
    indexPending: "正在准备建立该设备图片库索引。",
    invertSelection: "反选",
