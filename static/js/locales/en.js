...
export default {
  ...
  duplicates: {
    ...
    bulkDeleted: (count) => `Moved ${count} files to the Recycle Bin.`,
    bulkDeleting: (count) => `Moving ${count} files to the Recycle Bin...`,
    ...
    bulkStrictTitle: (count) => `Move ${count} strict duplicate files to the Recycle Bin`,
    confirmBulkStrictDelete: (count) =>
          `This will move ${count} strict duplicate files to the Recycle Bin. Only duplicate files will be processed; kept files will not be deleted. Continue?`,
    deleteSelected: "Delete",
    deleted: (path) => `Moved ${path} to the Recycle Bin`,
    deleting: (path) => `Moving ${path} to the Recycle Bin ...`,
    ...
    noStrictDuplicatesToDelete: "No strict duplicate files are available for bulk deletion.",
  ...
  recycle: {
    ...
    backToGallery: "Back to gallery",
    clearRecycle: "Clear",
    cleared: (count) => `Emptied ${count} files from the Recycle Bin.`,
    ...
    confirmClear: {
      ...
      messagePermanent: "Empty the Recycle Bin? On this system, files will be deleted permanently and cannot be recovered.",
      messageSystemRecycle: "Empty the Recycle Bin? Files will be moved to the Windows system Recycle Bin.",
