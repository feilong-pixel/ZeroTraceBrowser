...
export default {
  ...
  recycle: {
    ...
    clearSearchResultsTitle: (count) => `Clear ${count} matching Recycle Bin files on this page`,
    ...
    noRecycleSearchResults: "No Recycle Bin files match this search on the current page.",
    nextPage: "Next Page",
