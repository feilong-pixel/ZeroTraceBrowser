...
export default {
  ...
  iphone: {
    ...
    buildIndex: "Build Device Photo Library Index",
    cancelIndex: "Cancel Indexing",
    cancelIndexPending: "Cancel indexing is not wired yet. Any running backend indexing will continue.",
    clearSelection: "Clear",
    clearSelectionPending: "Result selection clearing is not wired yet.",
    copyAllPhotos: "Copy all photos from device",
    detectDevice: "Detect Device",
    detectFailed: "Device detection failed",
    detecting: "Detecting device...",
    detectPending: "Device detection is not wired yet. This page is ready to receive detected devices.",
    deviceDetected: "Device detected",
    deletePending: "Delete is not wired yet. The next step will write Recycle Bin records, but iPhone source files cannot be restored locally.",
    deleteSelected: "Delete",
    deleteFromDevice: "Delete From iPhone",
    deleteFromDeviceFailed: "Failed to delete from iPhone",
    deletedFromDevice: (target) => `Deleted from iPhone: ${target}`,
    deleteTarget: "Photo To Delete From iPhone",
    deleteTargetMissing: "Enter the iPhone photo filename to delete.",
    deleteTargetPlaceholder: "For example 100APPLE/IMG_0001.JPG",
    deletingFromDevice: "Deleting photo from iPhone...",
    deletingTarget: (target) => `Preparing to delete from iPhone: ${target}`,
    deviceName: "Device",
    deviceSection: "Device",
    deviceSelect: "Connected iPhone",
    deviceSummary: "Device Summary",
    endDate: "End Date",
    indexLimit: "Photos to index",
    indexed: (count) => `Device photo library index complete: ${count} images`,
    indexedImported: (count) => `Device photo library index complete: imported ${count} image`,
    indexedSkipped: (count) => `Device photo library index complete: skipped ${count} strict duplicate`,
    indexing: "Building device photo library index...",
    indexFailed: "Device photo library indexing failed",
    indexPending: "Preparing to build the device photo library index.",
    invertSelection: "Invert",
    invertSelectionPending: "Result selection inversion is not wired yet.",
    lastIndexedAt: "Last Indexed",
    liveOutput: "Device Output",
    logEmpty: "No iPhone operation started.",
    mediaCount: "Media",
    filenameMissing: "Enter a photo filename from the iPhone photo library.",
    method: "Method",
    methodEmbedding: "Doc Embedding",
    methodPhash: "pHash",
    movePending: "Move to local gallery is not wired yet.",
    moveToLocalGallery: "Move To Local Gallery",
    noDevice: "No device loaded",
    noDeviceDetected: "No iPhone device detected",
    noResults: "No similarity results yet.",
    pageIntro: "Index photos from a connected iPhone and review similar photos without importing them into the local gallery.",
    pageTitle: "iPhone Similarity",
    pending: "Pending",
    queryFilename: "Enter the filename of the photo to find similar matches for in the iPhone library:",
    queryFilenamePlaceholder: "For example IMG_2706.JPG",
    ready: "Ready",
    reviewSection: "Similarity Review",
    scanScope: "Scan Scope",
    scopeDcim: "DCIM",
    scopeRecent: "Recent samples",
    searchPending: "Similarity search is not wired yet. The current query settings are kept on the page.",
    searchSimilar: "Find Similar",
    selectAll: "Select All",
    selectAllPending: "Result select-all is not wired yet.",
    storage: "Storage",
    storageNote: "Device hashes will be cached in a local SQLite table by device id. Original photos stay on the iPhone.",
    startDate: "Start Date",
    threshold: "Threshold"
  },
  similarity: {
    ...
    methodEmbedding: "Doc Embedding",
    methodPhash: "pHash",
    noMatches: "No similar images found. Rebuild the Hash DB or raise the threshold if needed.",
    noResults: "No similarity results yet.",
    pageIntro: "Find visually similar photos in the current local image root from one explicit query image.",
    pageTitle: "Similar Photo Search",
    queryImage: "Query Image",
    queryMissing: "Enter a relative path from the current image root.",
    queryPath: "Query image relative path",
    queryPathPlaceholder: "For example 2026/05/IMG_0001.JPG",
    ...
    selectAll: "Select All",
    scope: "Scope",
    scopeNote: "This first version searches the current local root. iPhone and Android indexes can plug into this page later.",
  ...
  tasks: {
    ...
    skipExistingExactHelp: "Available when duplicate detection is Strict or Both. When a photo with the exact same SHA-256 is detected, only an organizer record is created and the file is not copied again.",
