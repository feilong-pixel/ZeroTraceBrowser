...
export default {
  ...
  browser: {
    ...
    buttons: {
      ...
      mobileImportTool: "Mobile Import",
  ...
  mobileImport: {
    ...
    confirmLeaveWhileIndexing: "Device indexing is still running. Leaving this page will not stop the backend import, but live output here will stop updating. Leave anyway?",
    ...
    logEmpty: "No mobile import operation started.",
    mediaCount: "Media",
    noMorePhotos: "No more photos to process.",
    noDevice: "No device loaded",
    noDeviceDetected: "No available device detected",
    pageIntro: "Index and import photos from mobile devices while keeping source deletion explicit and controlled.",
    pageTitle: "Mobile Import",
    pending: "Pending",
    ready: "Ready",
    ...
    storageNote: "Device hashes are cached locally by device id. Original photos stay on the phone unless you explicitly choose otherwise."
  },
  similarity: {
    backToGallery: "Back to gallery",
    clear: "Clear",
